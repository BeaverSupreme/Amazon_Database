...
# -*- coding: utf-8 -*-
"""
import_all_amazon_markets.py — WIELOPLATFORMOWY IMPORTER DLA 4 RYNKÓW (PL, UK, DE, FR)
======================================================================================
ZAKTUALIZOWANA CZYSTA WERSJA (Rozwiązanie błędu 'MARKETPLACES is not defined'):
1. Definiuje 4 kluczowe rynki Europy i polski e-commerce:
   - PL (Polska                - amazon.pl / allegro.pl)  — PLN (zł)
   - UK (Anglia/Wielka Brytania- amazon.co.uk / ebay.co.uk) — GBP (£)
   - DE (Niemcy                - amazon.de / ebay.de)     — EUR (€)
   - FR (Francja               - amazon.fr)               — EUR (€)
2. Definiuje 4 platformy: Amazon, Allegro (lider w PL), eBay (UK/DE), AliExpress (PL/EU).
3. Automatycznie tworzy bazę danych SQLite oraz aplikację webową (index.html + data.js) w 1 kroku!
...
# 4 Kluczowe rynki europejskie i angielskie
MARKETPLACES = [
...
# 4 Najważniejsze platformy w Europie
PLATFORMS = [
...
def update_facet_matrix(conn):
    ...
    """)
    conn.commit()
    print("[OK] Macierz fasetowa (facet_matrix) została zaktualizowana dla 4 rynków.")
