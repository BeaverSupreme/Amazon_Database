...
# -*- coding: utf-8 -*-
"""
import_all_amazon_markets.py — CZYSTY IMPORTER DLA 4 RYNKÓW (PL, UK, DE, FR) I 4 PLATFORM
=========================================================================================
ZAKTUALIZOWANA, W 100% CZYSTA WERSJA (Rozwiązanie błędu 'MARKETPLACES is not defined'):
1. Skrypt został wyczyszczony ze śladów połączenia z run_database_ui.py.
2. Definiuje 4 kluczowe rynki Europy (Polska PL, Anglia UK, Niemcy DE, Francja FR)
   oraz 4 platformy (Amazon, Allegro PL, eBay, AliExpress).
3. Samoczynnie tworzy tabele, generuje unikalne aukcje z archiwum cen 2025 r.
   i tworzy aplikację webową (index.html + data.js) w jednym kroku!
