...
# -*- coding: utf-8 -*-
"""
import_all_amazon_markets.py — WIELOPLATFORMOWY GENERATOR Z KAFELKAMI WYSZUKIWAŃ
================================================================================
ZAKTUALIZOWANA WERSJA (Rozwiązanie problemów ze stabilnością i kafelkami):
1. Jasny podział architektury na niezależne bloki (Źródła danych vs Rynki vs Kategorie).
2. Dodano KAFELKI Z WYSZUKIWARKAMI (Quick Search Tiles & History) na samej górze strony.
3. 100% stabilnego kodu JavaScript odpornego na błędy i konflikty przełączników.
4. Pełny katalog 4 rynków (PL, UK, DE, FR) oraz 4 źródeł (Allegro, Amazon, eBay, AliExpress).
...
# 4 Najważniejsze ŹRÓDŁA DANYCH w Europie
PLATFORMS = [
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; }
        ...
        /* BLOK 0: KAFELKI Z WYSZUKIWARKAMI (Quick Search Tiles & History) */
        ...
        /* BLOK 1: GLOBALNA WYSZUKIWARKA PRODUKTÓW */
        ...
        /* BLOKI 2, 3, 4: SEKCJE FILTRÓW Z JASNYM ROZDZIELENIEM ŹRÓDEŁ ZE STRONAMI */
...
<div class="container">
    ...
    <!-- BLOK 0: KAFELKI SZYBKICH WYSZUKIWAŃ (Quick Search Tiles & History) -->
    <div class="tiles-section">
        <div class="tiles-header">
            <span>🔥 Kafelki Szybkiego Wyszukiwania (Kliknij kafelek, aby od razu załadować wybraną sekcję rynku i platformy)</span>
            <span style="font-size:12px; color:#94a3b8;">Stabilny moduł zapytań</span>
        </div>
...
<script>
    ...
    // Stabilny handler KAFELKÓW WYSZUKIWANIA
    function applySearchTile(platformName, countryName, categorySlug) {
        ...
        // Odznacz wszystko i włącz wskazany kafelek
        ...
        filterAndRender(false);
        // Płynne przewinięcie do tabeli wyników
...
def export_static_web_app(limit_products, conn):
    ...
    print(f"  -> index.html  (interfejs z kafelkami szybkiego wyszukiwania dla PL, UK, DE, FR)")
    print(f"  -> data.js     (wyeksportowano komplet {len(products):,} ofert i aukcji)")
    print("====================================================================\n")

def seed_all_marketplaces(total_count, conn):
    print("====================================================================")
    print(f"  MASOWY IMPORT DLA 4 RYNKÓW (PL, UK, DE, FR) I 4 PLATFORM (Cel: {total_count:,})")
    print("====================================================================")
...
def main():
    parser = argparse.ArgumentParser(
        description="Importer dla 4 kluczowych rynków Europy (PL, UK, DE, FR) z kafelkami szybkiego wyszukiwania"
    )
