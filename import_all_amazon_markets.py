...
# -*- coding: utf-8 -*-
"""
import_all_amazon_markets.py — Importer z AUTOMATYCZNYM TWORZENIEM TABEL (0 Błędów Render.com)
=============================================================================================
ZAKTUALIZOWANA WERSJA:
1. Posiada wbudowaną funkcję create_schema_if_not_exists() — nawet jeśli uruchamiasz skrypt
   na całkowicie czystym serwerze Linux na Render.com, skrypt sam utworzy wszystkie wymagane
   tabele (products, countries, categories, facet_matrix).
2. Pełne wsparcie dla 21 rynków Amazon (w tym Polska amazon.pl) i zliczeń Bestsellerów.

Użycie na Render.com / lokalnie:
  python3 import_all_amazon_markets.py --seed-all 10000
"""
...
# =============================================================================
# 1. AUTOMATYCZNE TWORZENIE SCHEMATU TABEL (Gwarancja na czystych serwerach Linux/Render)
# =============================================================================
def create_schema_if_not_exists(conn):
    """Tworzy pełną strukturę bazy danych od zera, jeśli tabele jeszcze nie istnieją."""
    cursor = conn.cursor()
    cursor.execute("""
...
# =============================================================================
# 2. BŁYSKAWICZNY GENERATOR Z DANYMI O SPRZEDAŻY (30 DNI) I GWARANCJĄ AUKCJI
# =============================================================================
...
def main():
    parser = argparse.ArgumentParser(
        description="Importer dla 21 RYNKÓW AMAZON z automatycznym tworzeniem schematu tabel"
    )
